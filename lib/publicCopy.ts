export const HERO_HEADLINE = "A cleaner home, office, or rental\u2014without the stress.";
...
export const TRUST_MARKERS = [
  "Locally owned",
  "Homes \u00b7 Offices \u00b7 Vacation rentals",
  "Serving Newport & the Crystal Coast",
] as const;
...
export const SERVICE_BENEFITS: Record<string, string> = {
  ...
  office: "A tidy workspace that\u2019s ready for the next workday.",
